...
describe("AI service local conversation intelligence", () => {
  ...
  test("askAssistant returns a usable local answer without an API key", async () => {
        ...
        messages: [
          {
            id: 1,
            author: "Tarik",
            content: "Need to finish unit testing next.",
            created_at: "2026-06-14T10:00:00Z"
          }
        ]
      }
    ...
    expect(response.answer).toContain("Project chat");
  });
});
